...
export class ActivityLogService {
   ...
   */
  async logEffectorRequestCreated(
    requestId: string,
    createdByUserId: string,
    requestData: any,
    ipAddress?: string,
   ...
   */
  async logEffectorRequestApproved(
    requestId: string,
   ...
   */
  async logEffectorRequestRejected(
    requestId: string,
   ...
   */
  async logMedicalOrderAuthorized(
    orderId: string,
   ...
   */
  async logMedicalOrderAIAnalyzed(
    orderId: string,
    orderData: any,
    aiResult: any,
    ipAddress?: string,
